...
@section('contenido')
    ...
    <div class="container mt-3">
        ...
        <form action="{{route('notas.update', $Nota)}}" method="POST" enctype="multipart/form-data" id="formulario" autocomplete="off">
            @method('put')
            @csrf
            ...
            <div class="row mt-5 border border-4 rounded">
                ...
                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-12 mb-2">
                    ...
                    <label for="fecha">Fecha de Elaboracion</label>
            ...
            <div class="row border border-4 rounded mt-2 pb-4">
                <div class="row mt-2">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                        ...
                        <input type="text" id="Tema" name="Tema" class="form-control" value="{{ $Nota->Tema }}" > 
                        @error('Tema')
                        <span class="invalid-feedback" role="alert" style=" text-align: center; display: flex; justify-content: center; align-items: center;">
                            <strong>{{ $message }}</strong>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="FechaProximoSeguimiento" value="{{ $Nota->FechaProximoSeguimiento }}"  name="FechaProximoSeguimiento" />
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 mb-2">
                        ...
                        <textarea name="Observaciones" id="Observaciones" class="form-control mx-1"> {{ $Nota->Observaciones }} </textarea>  
                        @error('Observaciones')
                            <span class="invalid-feedback" role="alert" style=" text-align: center; display: flex; justify-content: center; align-items: center;">
                                <strong>{{ $message }}</strong>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-center "> 
                        <label for="Estatus" class="form-check-label mt-5">Seguimiento Terminado</label>
                        <input class="form-check-input mx-2 mt-5" type="checkbox" value="false" id="Estatus" name="Estatus">
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid d-flex flex-wrap justify-content-center align-items-center mt-3 pb-5">
                ...
                <a href="">
                    ...
                    <button class="boton2 mx-auto btn-block" type="submit">Actualizar nota</button>
                    </div>
                </a>
            </div>
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('js/ModuloClientes/ShowNota.js') }}"></script>
@endsection

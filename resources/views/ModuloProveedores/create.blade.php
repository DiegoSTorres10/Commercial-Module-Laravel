...
@section('contenido')
    ...
    <div class="container mt-5 ">
        ...
        <form action="{{ route('proveedores.store') }}" method="POST" enctype="multipart/form-data" id="formulario"
            autocomplete="off">
            @csrf
            <div class="row mt-3">
            ...
            <div class="container-fluid d-flex flex-wrap justify-content-center align-items-center mt-3 pb-5">
                ...
                <a href="">
                    <div class="text-center mt-1  mb-1 mx-4 flex-fill">
                        <button class="boton2 mx-auto btn-block" type="submit">Agregar nuevo proveedor</button>
                    </div>
                </a>
            </div>
        </form>
